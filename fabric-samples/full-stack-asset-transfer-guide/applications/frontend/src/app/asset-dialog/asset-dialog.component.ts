  ...
  onSubmit() {
    ...
    if (this.data) {
      var request = {
        ...
        AppraisedValue: this.form.value.AppraisedValue,
        ID: this.data.ID,
        Size: this.form.value.Size,
        Owner: { org: 'Users', user: this.form.value.Owner },
      };
      this._http
        .post<any>(URLS.UPDATE, JSON.stringify(request), this.httpOptions)
        .subscribe((data: any) => {
          console.log(data);
          var response = {
            Color: this.form.value.Color,
