    ...
    try {
        ...
        try {
            ...
            result = await contract.evaluateTransaction(
                ...
                '{"selector":{"docType":"asset","owner":"Max"}, "use_index":["_design/indexOwnerDoc", "indexOwner"]}',
                '1',
                '',
            );
            console.log(`*** Result: ${prettyJSONString(result.toString())}`);
            ...
            result = await contract.evaluateTransaction(
                'QueryAssets',
                '{"selector":{"docType":"asset","owner":"Jin Soo"}, "use_index":["_design/indexOwnerDoc", "indexOwner"]}',
            );
            console.log(`*** Result: ${prettyJSONString(result.toString())}`);
